...
Ext.define('vegl.models.Download', {
    ...
    fields: [
        ...
        { name: 'eastBoundLongitude', type: 'number'}, //The spatial location of this download in WGS84
        { name: 'northBoundLatitude', type: 'number'}, //The spatial location of this download in WGS84
        { name: 'southBoundLatitude', type: 'number'}, //The spatial location of this download in WGS84
        { name: 'westBoundLongitude', type: 'number'} //The spatial location of this download in WGS84
    ],
