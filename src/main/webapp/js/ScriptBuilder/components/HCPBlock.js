...
Ext.ux.ComponentLoader.load({url: ScriptBuilder.componentPath+"HCPBlock.json"});

HCPBlockNode = Ext.extend(ScriptBuilder.BaseComponent, {
  constructor: function(container) {
    FCCBlockNode.superclass.constructor.apply(this,
        [container, "HCP Block", "HCPBlock", "g"]
    );
  },
