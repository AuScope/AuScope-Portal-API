...
VEGLStep6Node = Ext.extend(ScriptBuilder.BasePythonComponent, {
  ...
  getScript: function() {
    ...
    text += this._tab + "VEGLPaddedBox = " + this.values.paramsInstance  + ".getPaddedBounds()" + this._newLine;
    ...
    text += this._tab + "invDepth = " + this.values.paramsInstance  + ".getInversionDepth()" + this._newLine;
    text += this._tab + "cell_x = " + this.values.paramsInstance  + ".getCellX()" + this._newLine;
    text += this._tab + "cell_y = " + this.values.paramsInstance  + ".getCellY()" + this._newLine;
    text += this._tab + "cell_z = " + this.values.paramsInstance  + ".getCellZ()" + this._newLine;
