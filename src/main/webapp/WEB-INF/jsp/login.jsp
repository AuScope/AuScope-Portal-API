...
<body>
    ...
    <div id="body">
    You are not authorised to view this page. Please select a login option from the choices below:<br>
    <a href="google/google_login.html">Google</a><br>
    <a href="aaf/aaf_login.html">AAF</a><!-- XXX -->
    </div>
