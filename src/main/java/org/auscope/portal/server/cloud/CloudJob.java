...
public abstract class CloudJob implements Serializable {
	...
	/**
	 * Gets the ID of the Amazon Machine Instance (Virtual Machine) that runs this job 
	 * @return
	 */
	...
	/**
	 * Sets the ID of the Amazon Machine Instance (Virtual Machine) that runs this job
	 * @param ec2ami
	 */
