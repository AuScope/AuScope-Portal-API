...
/**
 * A class for making HttpMethods that can communicate with an instance of Geonetwork
 * @author Josh Vote
 *
 */
@Repository
public class GeonetworkMethodMaker {

	private String appendUrl(String base, String suffix) {
		String url = base;
		if (!url.endsWith("/")) {
			url += "/";
		}
	...
	public HttpMethodBase makeUserLogoutMethod(String baseGeonetworkUrl, String sessionCookie) {
		String url = appendUrl(baseGeonetworkUrl, "srv/en/xml.user.logout");
	...
	public HttpMethodBase makeUserLoginMethod(String baseGeonetworkUrl, String userName, String password) {
		String url = appendUrl(baseGeonetworkUrl, "srv/en/xml.user.login");
	...
	public HttpMethodBase makeInsertRecordMethod(String baseGeonetworkUrl, String mdMetadataXml, String sessionCookie) throws UnsupportedEncodingException {
		String url = appendUrl(baseGeonetworkUrl, "srv/en/csw");
	...
	public HttpMethodBase makeRecordMetadataShowMethod(String baseGeonetworkUrl, String uuid, String sessionCookie) {
		String url = appendUrl(baseGeonetworkUrl, String.format("srv/en/metadata.show?uuid=%1$s", uuid));
	...
	public HttpMethodBase makeRecordPublicMethod(String baseGeonetworkUrl, String recordId, String sessionCookie) {
		String url = appendUrl(baseGeonetworkUrl, String.format("srv/en/metadata.admin?id=%1$s&_1_0=on&_1_1=on&_1_5=on&_1_6=on", recordId));
