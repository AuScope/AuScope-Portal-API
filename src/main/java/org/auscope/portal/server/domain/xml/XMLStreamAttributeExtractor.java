...
/**
 * This class is for extracting all attributes of a specific element type from
 * an XML Stream
 * 
 * It exists to offer a high performance low memory method of parsing an XML
 * stream in a simplistic manner
 *
 */
public class XMLStreamAttributeExtractor implements Iterator<String> {
     ...
     *            The FQ XML element name you will be searching for
     * @param attributeToFind
     *            The FQ attribute within elementToMatch that will be extracted
     * @param xmlStream
     ...
     * @param xmlStream
     *            The input XML stream
     * @param xmlStreamCharset
     *            The optional charset for the input stream.
     */
    public XMLStreamAttributeExtractor(String elementToMatch, String attributeToFind, InputStream xmlStream,
            String xmlStreamCharset) {
    ...
    /**
     * Returns true if there is another attribute value to extract from this
     * extractor
     * 
     * @return
     */
