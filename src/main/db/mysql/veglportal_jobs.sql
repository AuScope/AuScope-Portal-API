...
CREATE TABLE `jobs` (
  ...
  `storageProvider` varchar(255) DEFAULT NULL,
  `storageEndpoint` varchar(255) DEFAULT NULL,
  `storageBucket` varchar(255) DEFAULT NULL,
  `storageBaseKey` varchar(255) DEFAULT NULL,
  `storageAccessKey` varchar(255) DEFAULT NULL,
  `storageSecretKey` varchar(255) DEFAULT NULL,
