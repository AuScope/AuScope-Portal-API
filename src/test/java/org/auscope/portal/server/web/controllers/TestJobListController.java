...
public class TestJobListController {
    ...
    public void init() {
        ...
        controller = new JobListController(mockJobManager, mockJobStorageService, mockJobFileService, mockJobExecutionService);
    ...
    public void testDeleteJob() {
        ...
        context.checking(new Expectations() {{
            ...
            oneOf(mockJobFileService).deleteStageInDirectory(mockJob);
    ...
    public void testDeleteSeries() {
        ...
        context.checking(new Expectations() {{
            ...
            oneOf(mockJobFileService).deleteStageInDirectory(mockJobs.get(0));
            oneOf(mockJobManager).deleteJob(mockJobs.get(0));
            oneOf(mockJobFileService).deleteStageInDirectory(mockJobs.get(1));
    ...
    public void testKillJob() {
        ...
        context.checking(new Expectations() {{
            ...
            oneOf(mockJobExecutionService).terminateJob(mockJob);
    ...
    public void testKillSeriesJobs() {
        ...
        context.checking(new Expectations() {{
            ...
            oneOf(mockJobExecutionService).terminateJob(mockJobs.get(3));
    ...
    public void testListJobFiles() throws Exception {
        ...
        context.checking(new Expectations() {{
            ...
            oneOf(mockJobStorageService).getOutputFileDetails(mockJob);will(returnValue(fileDetails));
        }});
    ...
    public void testDownloadJobFile() throws Exception {
        ...
        context.checking(new Expectations() {{
            ...
            oneOf(mockJobStorageService).getJobFileData(mockJob, key);will(returnValue(inputStream));
    ...
    public void testDownloadJobFilesAsZip() throws Exception {
        ...
        context.checking(new Expectations() {{
            ...
            oneOf(mockJobStorageService).getJobFileData(mockJob, fileKey1);will(returnValue(is1));
            oneOf(mockJobStorageService).getJobFileData(mockJob, fileKey2);will(returnValue(is2));
            oneOf(mockJobStorageService).getJobFileData(mockJob, fileKey3);will(returnValue(is3));
    ...
    public void testListJobs() throws Exception {
        ...
        context.checking(new Expectations() {{
            ...
            oneOf(mockJobStorageService).getOutputFileDetails(with(mockJobs.get(0)));will(returnValue(jobActiveFiles));
            oneOf(mockJobStorageService).getOutputFileDetails(with(mockJobs.get(2)));will(returnValue(jobDoneFiles));
