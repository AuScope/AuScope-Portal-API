...
/**
 * Unit tests for JobStorageService
 * @author Josh Vote
 *
 */
public class TestJobStorageService extends JobStorageService {
    ...
    public void testGetJobFileData() throws Exception {
        ...
        context.checking(new Expectations() {{
            oneOf(mockS3Service).getObject(job.getS3OutputBucket(), myKey);will(returnValue(mockS3Obj));
    ...
    public void testListOutputJobFiles() throws Exception {
        ...
        Assert.assertEquals(obj1Key, fileInfo[0].getS3Key());
        Assert.assertEquals(obj1Length, fileInfo[0].getSize());
        Assert.assertEquals(obj2Key, fileInfo[1].getS3Key());
    ...
    public void testUploadJobFiles() throws Exception {
        ...
        context.checking(new Expectations() {{
            oneOf(mockS3Service).getOrCreateBucket(job.getS3OutputBucket());will(returnValue(mockBucket));
