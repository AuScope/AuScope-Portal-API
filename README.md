...
1) When using for AuScope Portal development, for a faster startup time, it is recommended to comment out the "cswGAECat" entry in https://github.com/AuScope/AuScope-Portal-API/blob/master/src/main/resources/application-registries.yaml
